// src/app/extract-cte/page.tsx
"use client";

import * as React from "react";
import { useState, type ChangeEvent } from "react";
import Link from 'next/link';
import { Sheet, UploadCloud, Download, Trash2, File as FileIcon, Loader2, History, Group, ChevronDown, FileText, FolderSync, Search, Replace, Layers, Calculator, GitCompare } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
import { extractCteData } from "@/app/actions";

export default function ExtractCtePage() {
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const result = await extractCteData(fileContents);
            ...
            if(result.base64Data) {
                ...
                toast({
                    ...
                    description: "O download da sua planilha com os dados do CT-e foi iniciado.",
                });
            }
                     ...
                     <Card className="shadow-lg">
                        <CardHeader>
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <CardTitle className="font-headline text-2xl">Extrair Dados de CT-e</CardTitle>
                                    <CardDescription>Carregue arquivos XML de CT-e para extrair dados em uma planilha Excel.</CardDescription>
                                </div>
                            </div>
                        </CardHeader>
                        <CardContent className="space-y-6">
                            <div className="relative flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-border bg-secondary/50 p-8 transition-all">
                                <label htmlFor="file-upload" className="flex h-full w-full cursor-pointer flex-col items-center justify-center text-center">
                                    ...
                                    <p className="mt-4 font-semibold">Clique para carregar arquivos XML de CT-e</p>
