...
import { KeyRound, FileText, Loader2, Sheet, History, Group } from "lucide-react";
                    ...
                    <Card className="shadow-lg">
                        <CardHeader>
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <CardTitle className="font-headline text-2xl">Validação de Chaves vs. SPED</CardTitle>
                        ...
                        <CardContent>
                             {loading ? (
                                ...
                                <KeyResultsDisplay results={results} cnpj={spedInfo?.cnpj ?? null} />
                            ) : (
                                <Alert>
