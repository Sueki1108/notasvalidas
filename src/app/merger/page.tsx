...
import { Sheet, UploadCloud, Group, Download, Trash2, File as FileIcon, Loader2, History, ChevronDown, FileText, FolderSync, Search, Replace, Layers } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
